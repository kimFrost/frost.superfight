(function (window, document, undefined) {
  ...
  /* @ngInject */
  function CatchgameCtrl($rootScope, $scope) {
    ...
    // Public variables
    base.states = data.states;
    base.gameTicks = data.gameTicks;
...
---------------------------------------**/
    ...
    var recal = function() {
      ...
      player.y = data.canvasHeight - (200 * data.scaleMultiplier);
...
---------------------------------------**/
    var initiate = function () {
      ...
      player.y = data.canvasHeight - 200;
